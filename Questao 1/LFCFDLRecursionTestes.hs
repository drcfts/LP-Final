...
import LFCFDLRecursion

import Test.HUnit

v5 = Valor 5

let0 = Let "x" (Valor 5) (Valor 2)
...
-- Funcao fatorial
letR1 = LetR "fac" (Valor 5) (Lambda "x" (If0 (Ref "x") (Valor 1) (Multiplicacao (Ref "x") (LetR "fac" (Subtracao (Ref "x") (Valor 1))(Ref "fac") )))) 
